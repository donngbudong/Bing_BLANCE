...
{
	Shoot_Ctrl_FRIC_L(&Shoot.Motor_Data[FRIC_L], 6000);
	Shoot_Ctrl_FRIC_R(&Shoot.Motor_Data[FRIC_R],-6000);
...
{
	Shoot_KEY_F();
	Shoot_Ctrl_FRIC_L(&Shoot.Motor_Data[FRIC_L],4000);
	Shoot_Ctrl_FRIC_R(&Shoot.Motor_Data[FRIC_R],-4000);
	Shoot_Ctrl_DRIVER(&Shoot.Motor_Data[DRIVER]);
	Shoot_KEY_Fire();
