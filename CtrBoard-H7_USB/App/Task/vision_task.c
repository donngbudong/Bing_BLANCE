...
//	st.tracking = Vision_cj.VisionRTx.AutoAim_Rx.Packet.RxData.check<<1;
//	st.armor_id = Vision_cj.VisionRTx.AutoAim_Rx.Packet.RxData.check<<4;
//	st.armor_num = Vision_cj.VisionRTx.AutoAim_Rx.Packet.RxData.check<<7;
}
